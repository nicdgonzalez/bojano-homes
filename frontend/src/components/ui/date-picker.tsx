  ...
  return (
    <DatePickerPrimitive.PrevTrigger
      class={cn(
        ...
        "size-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-gray-300 dark:border-gray-700 hover:cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-700 rounded-sm",
        local.class,
      )}
      {...others}
    >
  ...
  return (
    <DatePickerPrimitive.ViewTrigger
      class={cn(
        ...
        "h-7 hover:cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 rounded-sm",
        local.class,
      )}
      {...others}
    />
...
const DatePickerTableCell = (props: DatePickerPrimitive.TableCellProps) => {
  ...
  return (
    <DatePickerPrimitive.TableCell
      class={cn(
        "flex-1 p-0 hover:cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 rounded-sm text-center text-sm has-[[data-range-end]]:rounded-r-md has-[[data-range-start]]:rounded-l-md has-[[data-in-range]]:bg-accent has-[[data-outside-range][data-in-range]]:bg-accent/50 has-[[data-in-range]]:first-of-type:rounded-l-md has-[[data-in-range]]:last-of-type:rounded-r-md",
        local.class,
      )}
      {...others}
    />
